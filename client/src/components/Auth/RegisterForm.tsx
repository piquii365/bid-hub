          ...
          <div className="relative z-10 flex flex-col justify-center px-12 text-white">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-200 mb-8 leading-relaxed">
                Join the most trusted property bidding platform and discover amazing 
                investment opportunities. Whether you're buying or selling, we've got you covered.
              </p>
            </div>
            ...
            <div className="mt-12 p-6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">Ready to get started?</div>
                <div className="text-gray-300">Join thousands of successful investors</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className={`ml-2 text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                  I agree to the{' '}
                  <Link to="/terms" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                    Privacy Policy
                  </Link>
                </span>
              </div>
