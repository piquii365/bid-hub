...
export default function RegisterForm() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 min-h-screen flex items-center justify-center lg:justify-end px-4 lg:px-16 py-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`flex items-center justify-center p-3 rounded-lg border transition-colors backdrop-blur-sm ${
