    ...
    <div className="space-y-6">
      ...
      <div
        className={`space-y-6 transition-all duration-300 ${
          isOpen ? "block opacity-100" : "hidden md:block opacity-100"
        }`}
      >
        {/* Search */}
        <div>
        ...
        <div>
          ...
          <select
            ...
            className={`w-full px-4 py-3 rounded-lg transition-all duration-200 appearance-none cursor-pointer ${
              theme === "dark"
                ? "bg-gray-800/50 text-white focus:bg-gray-800"
                : "bg-gray-50 text-gray-900 bg-white"
            } focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:shadow-lg`}
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg transition-all duration-200 ${
                  theme === "dark"
                    ? "bg-gray-800/50 text-white placeholder-gray-400 focus:bg-gray-800"
                    : "bg-gray-50 text-gray-900 placeholder-gray-500 bg-white"
                } focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:shadow-lg`}
              />
            </div>
            <div className="relative">
