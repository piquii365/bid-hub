        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className={`text-xl mb-8 max-w-3xl mx-auto ${
              ...
              We're on a mission to make property investment accessible, transparent, and exciting for everyone. 
              Join thousands of investors who trust BidHub for their property bidding needs.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className={`text-lg mb-6 ${
                ...
                At BidHub, we believe that everyone should have access to exciting investment opportunities. 
                We've created a platform that combines the thrill of auctions with the security and 
      ...
      <section className={`py-20 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful investors who trust BidHub for their property investments.
          </p>
